 ...
 * 抽象责任链上下文
 */
public final class AbstractChainContext<T> implements CommandLineRunner { // CommandLineRunner：SpringBoot 启动完成后执行的回调函数
    ...
    public void run(String... args) throws Exception {
        // 调用 SpringIOC 工厂获取 AbstractChainHandler 接口类型的 Bean
